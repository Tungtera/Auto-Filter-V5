...
API_ID = int(environ.get('API_ID', '11973876'))
API_HASH = environ.get('API_HASH', '3adc81852c32f405db0d7816ba82de19')
BOT_TOKEN = environ.get('BOT_TOKEN', "5867201883:AAEWpXuEIcCLa-VkmFzvK8m6cWTjIayXZ28")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/7b5c2747cad5bc334873e.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tungsaab106:tungsaab107@cluster0.xdu2dyq.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "tungdatabase")
